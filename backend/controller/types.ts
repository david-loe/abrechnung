import { Currency, CurrencyCode, DocumentFile, DocumentFileType, Money, Travel, TravelDay, TravelSimple, _id } from '../../common/types.js'
import { SetterBody } from './controller.js'

export type IdDocument<idType = _id> = idType | { _id: idType }

export interface File<T extends DocumentFileType = DocumentFileType> extends Omit<DocumentFile<T>, 'data' | 'owner'> {
  /**
   * @format binary
   */
  data?: string
