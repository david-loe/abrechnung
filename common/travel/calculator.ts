...
export class TravelCalculator {
  ...
  getDays(stages: Stage<_id, binary>[], oldDays?: InputTravelDay[]) {
    if (stages.length > 0) {
  ...
  getProfessionalShare(days: InputTravelDay[]) {
    if (days.length > 0) {
