...
import { _id, ApprovedTravel, Locale, Place } from '../types.js'
...
export class ApprovedTravelsPrinter<idType extends _id> extends Printer<idType> {
  ...
  async print(travels: ApprovedTravel[], language: Locale, from?: Date, to?: Date) {
    ...
    columns.push({ key: 'reason', width: 150, alignment: TextAlignment.Left, title: this.translateFunc('labels.reason', language) })
    columns.push({
      key: 'appliedForOn',
