      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <TravelApproveForm ref="travelApproveForm" v-if="modalTravel" :travel="modalTravel" @cancel="hideModal()" @decision="approveTravel"></TravelApproveForm>
          </div>
        </div>
      </div>
    </div>
