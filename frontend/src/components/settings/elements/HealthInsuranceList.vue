<template>
  <div>
    <ListElement class="mb-3" ref="list" endpoint="healthInsurance" :filter="filter" :headers="headers" dbKeyPrefix="admin">
...
import { HealthInsurance } from 'abrechnung-common/types.js'
