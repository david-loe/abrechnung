      ...
      :filter-options="[
        {
          ...
          comparison: (value: Country['name'], criteria: string): boolean => value[$i18n.locale].toLowerCase().indexOf(criteria.toLowerCase()) !== -1
        }
      ]"
      :headers="[
...
import { Country, accesses } from '../../../../../common/types.js'
