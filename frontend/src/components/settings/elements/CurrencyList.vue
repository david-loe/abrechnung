<template>
  <div>
    <ListElement class="mb-3" ref="list" endpoint="currency" :filter="filter" :headers="headers">
...
const schema = Object.assign({}, (await API.getter<any>('admin/currency/form')).ok?.data, {
  buttons: {
    type: 'group',
    schema: {
