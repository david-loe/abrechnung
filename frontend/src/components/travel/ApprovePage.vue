  ...
  <div>
    ...
    <div class="container">
      ...
      <TravelList
        ...
        :columns-to-hide="['state', 'editor', 'addUp', 'updatedAt', 'report']"></TravelList>
      ...
      <template v-else>
        ...
        <hr class="hr" />
        <TravelList endpoint="approve/travel" stateFilter="approved" :columns-to-hide="['state', 'addUp', 'updatedAt', 'report']">
        </TravelList>
      </template>
    </div>
  </div>
