    ...
    <ModalComponent @hideModal="hideModal()"
      ...
      <div v-if="travel._id" class="modal-body">
        ...
        <StageForm v-if="modalObjectType === 'stage'" ref="stageForm" :mode="modalMode"
          ...
          :travelEndDate="travel.endDate" :disabled="isReadOnly" :showVehicleRegistration="travel.state === 'approved'"
          :endpointPrefix="endpointPrefix" :ownerId="endpointPrefix === 'examine/' ? travel.owner._id : undefined"
          @add="postStage" @edit="postStage" @deleted="deleteStage" @cancel="hideModal"
